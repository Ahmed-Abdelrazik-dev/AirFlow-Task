...
default_args = {
    ...
    "email": "am.abdelrazik97@gmail.com",
    "retries": 1,
...
with DAG("forex_data_pipeline_V6_final", start_date=datetime(2021, 1 ,1), 
...
# Tast for creating Hive table
	...
	webhook_token="T02226ZE8GG/C021JHLK96Y",
...
# Organizing the workflow
    ...
    forex_processing >> email_notification >> slack_notification
